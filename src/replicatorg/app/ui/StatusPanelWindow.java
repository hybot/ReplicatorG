...
public class StatusPanelWindow extends JFrame implements
	...
	public static synchronized StatusPanelWindow getStatusPanel(MachineController m) {
		if (instance == null) {
	...
	protected JComponent createToolsPanel() {
		...
		for (Enumeration<ToolModel> e = machine.getModel().getTools().elements(); e
			...
			if (t.getType().equals("extruder")) {
				...
				StatusPanel statusPanel = new StatusPanel(machine,t);
	...
	class PollThread extends Thread {
		...
		public PollThread(Driver d) {
			super("Status Panel Poll Thread");
